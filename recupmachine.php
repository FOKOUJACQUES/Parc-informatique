                                            ...
                                            <?php
                                                class Machine{
                                                    ...
                                                    public function afficherProprietes(){
                                                        $query = $this->pdo->prepare("SELECT code_interne, numero_de_serie, modele, type, marque, ram, disque_dur, date_d_achat, cout, etat, date_de_modification, date_acquisition, processeur, taille_ecran FROM machines");
                                                        $query->execute();
