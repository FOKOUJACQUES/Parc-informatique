                                            ...
                                            <div class="container">
                                                ...
                                                ?>
                                                    <div class="form-group">
                                                        ...
                                                        <select id="etablissement" name="ecole" class="form-holder form-holder-2" style="width:100%; padding: 10px; color: #4e4f50; border: 2px solid #c5c4c4">
                                                            <?php
                                                    ...
                                                    <input type="submit" value="Envoyer" name="seach" class="btn btn-primary">
                                                </form>
                                            </div>
                                        </div>                                  
                                    </div>
