...
<body>
  <div class="container-scroller">
    ...
    <!-- partial -->
    <div class="container-fluid page-body-wrapper" style="background-color: #5a220b;">
    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="Saveproduit.php">
                <i class="icon-paper menu-icon"></i>
                <span class="menu-title">Enregistrer un produit</span>
            </a>
        </li>
    </ul>
</nav>
                  ...
                  <div class="col-md-12 grid-margin">
                    <div class="row">
                      <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Bienvenu au service informatique de ESG</h3>
