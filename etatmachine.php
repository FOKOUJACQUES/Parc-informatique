                            ...
                            <div class="content-wrapper">
                                <div class="row">
                                    <div class="col-md-8 grid-margin">
                                        <div class="row">
                                        <a href="besoin.php">Soumettre un besoin d'intervention</a><br>
                                            <style>
                                                .table th {
                                                    font-size: 30px;
                                                    font-weight: bold;
                                            ...
                                            <?php
                                                ...
                                                $query = $this->pdo->prepare("SELECT code_interne, numero_de_serie, type, marque, etat, taille_ecran FROM machines");
                                                $query->execute();
                                    ...
                                    <div class="col-md-3">
                                        <form action="" method="post" id="machineForm">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select" id="ecole" name="ecole" style="width:100%; padding: 10px; color: #4e4f50; border: 2px solid #c5c4c4">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-6">
                                                    <label for="annee_debut">Période du:</label>
                                                    <input type="date" id="annee_debut" name="annee_debut" class="form-control">
                                                </div>
                                                <div class="col-6">
                                                    <label for="annee_fin">Au:</label>
